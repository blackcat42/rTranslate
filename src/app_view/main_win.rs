...
impl MainWinView {
    pub fn new(app_sender: fltk::app::Sender<AppEvent>) -> Self {
    	...
    	////////////////////---------------BEGIN MAIN WIN---------------/////////////////////        
        let mut main_win = window::Window::default().with_size(ui_scale(800), ui_scale(600)).with_label("rTranslate");
        let mut main_flex_wrapper = group::Flex::new(0,0,ui_scale(800),ui_scale(600),None);
        main_flex_wrapper.set_type(group::FlexType::Column);
        let main_flex_wrapper_inner = group::Flex::default().row();

        let mut main_flex_left = group::Flex::new(0,0,ui_scale(400), ui_scale(585),None);
        ...
        main_src_txt_wrapper.set_pad(ui_scale(5));
        main_src_txt_wrapper.set_margins(ui_scale(5),ui_scale(25),ui_scale(5),ui_scale(5));
        ...
        let mut lang_choice_from = fltk::menu::Choice::default().with_size(ui_scale(30), ui_scale(10)).with_label(t!(from)).with_align(fltk::enums::Align::TopLeft);
        ...
        let mut lang_choice_to = fltk::menu::Choice::default().with_size(ui_scale(30), ui_scale(10)).with_label(t!(to)).with_align(fltk::enums::Align::TopLeft);
        for lng in Lang::iter() {
            lang_choice_to.add(
                lng.clone().name(),
                fltk::enums::Shortcut::None,
        ...
        col_left_row_lng.set_margins(0,ui_scale(15),0,ui_scale(15));
        main_controls_left.fixed(&col_left_row_lng, ui_scale(55));
        col_left_row_lng.end();

        let mut col_left_row_tr = group::Flex::default().row();

        let mut transl_choice = fltk::menu::Choice::default().with_size(ui_scale(30), ui_scale(10)).with_label(t!(translate_with)).with_align(fltk::enums::Align::TopLeft);
        ...
        let mut run_transl_btn_main = button::Button::default().with_label(t!(translate_refresh)).with_size(ui_scale(20), ui_scale(20));
        ...
        col_left_row_tr.fixed(&run_transl_btn_main, ui_scale(150));

        col_left_row_tr.set_margins(0,ui_scale(15),0,0);
        main_controls_left.fixed(&col_left_row_tr, ui_scale(40));
        col_left_row_tr.end();

        let mut col_left_row_dict = group::Flex::default().row();
        let mut dict_choice = fltk::menu::Choice::default().with_size(ui_scale(30), ui_scale(10)).with_label(t!(dictionary)).with_align(fltk::enums::Align::TopLeft);
        ...
        let mut run_dict_btn_main = button::Button::default().with_label(t!(send_to_dict)).with_size(ui_scale(20), ui_scale(20));
        ...
        col_left_row_dict.fixed(&run_dict_btn_main, ui_scale(150));

        col_left_row_dict.set_margins(0,ui_scale(15),0,0);
        main_controls_left.fixed(&col_left_row_dict, ui_scale(40));
        col_left_row_dict.end();

        let mut col_left_row_tts = group::Flex::default().row();
        let mut tts_choice = fltk::menu::Choice::default().with_size(ui_scale(50), ui_scale(10)).with_label(t!(tts_engine_voice)).with_align(fltk::enums::Align::TopLeft);
        ...
        let mut _col1_row1_tts_but = button::Button::default().with_size(ui_scale(10), ui_scale(10)).with_label(t!(play));
        ...
        let mut prnn_choice = fltk::menu::Choice::default().with_size(ui_scale(50), ui_scale(10)).with_label(t!(pronunciation)).with_align(fltk::enums::Align::TopLeft);
        ...
        let mut _col1_row2_prnn_but = button::Button::default().with_size(ui_scale(10), ui_scale(10));
        ...
        col_left_row_tts.fixed(&_col1_row1_tts_but, ui_scale(55)); //25
        col_left_row_tts.fixed(&_col1_row2_prnn_but, ui_scale(25));
        //col_left_row_tts.fixed(&_col1_row2_prnn_refresh_but, 25);

        col_left_row_tts.set_margins(0,ui_scale(15),0,0);
        main_controls_left.fixed(&col_left_row_tts, ui_scale(40));
        col_left_row_tts.end();


        let mut col_left_row_fav = group::Flex::default().row();
        let mut fav_button_main = button::Button::new(ui_scale(51), ui_scale(5), ui_scale(18), ui_scale(18), "").with_label(t!(add_to_fav));
        ...
        col_left_row_fav.fixed(&fav_button_main, ui_scale(175));
        //col_left_row_fav.fixed(&refresh_button_main, 100);
        col_left_row_fav.set_margins(0,ui_scale(15),0,0);
        main_controls_left.fixed(&col_left_row_fav, ui_scale(40));
        col_left_row_fav.end();


        main_controls_left.set_margins(ui_scale(5),ui_scale(15),ui_scale(5),ui_scale(5));
        main_flex_left.fixed(&main_controls_left, ui_scale(240));
        main_controls_left.end();

        //TABS
        let mut col_main_tabs = group::Flex::default().row().with_pos(ui_scale(5), 0);
        let mut tab = group::Tabs::default().with_size(ui_scale(100), ui_scale(50)); //::default_fill not working in debug mode
        ...
        let mut browser = browser::HoldBrowser::new(0, ui_scale(20), ui_scale(200), ui_scale(200), None);
        browser.set_column_widths(&[ui_scale(100), ui_scale(100)]);
        browser.set_column_char('\t');
        history_browser_wrapper.set_pad(ui_scale(5));
        history_browser_wrapper.set_margin(ui_scale(5));
        ...
        let mut fav_browser = browser::HoldBrowser::new(0, ui_scale(20), ui_scale(200), ui_scale(200), None);
        fav_browser.set_column_widths(&[ui_scale(100), ui_scale(100)]);
        fav_browser.set_column_char('\t');
        fav_browser_wrapper.set_pad(ui_scale(5));
        fav_browser_wrapper.set_margin(ui_scale(5));
        ...
        main_flex_left.fixed(&col_main_tabs, ui_scale(200));
        col_main_tabs.set_pad(ui_scale(5));
        col_main_tabs.set_margins(ui_scale(5),ui_scale(25),ui_scale(5),ui_scale(10));
        col_main_tabs.end();
        //TABS END
        ...
        //SECOND COLUMN
        let mut main_flex_right = group::Flex::new(ui_scale(400),0,ui_scale(400),ui_scale(585),None);
        ...
        main_flex_right.fixed(&main_dict_txt, ui_scale(125));

        let mut dict_assets_browser = browser::HoldBrowser::new(0, 0, ui_scale(200), ui_scale(200), None).with_label(t!(prnn_cached)).with_align(fltk::enums::Align::TopLeft);
        dict_assets_browser.set_column_widths(&[ui_scale(100), ui_scale(100)]);
        dict_assets_browser.set_column_char('\t');
        main_flex_right.fixed(&dict_assets_browser, ui_scale(125));

        let mut tts_browser = browser::HoldBrowser::new(0, 0, ui_scale(200), ui_scale(200), None).with_label(t!(tts_cached)).with_align(fltk::enums::Align::TopLeft);
        tts_browser.set_column_widths(&[ui_scale(100), ui_scale(100)]);
        tts_browser.set_column_char('\t');
        main_flex_right.fixed(&tts_browser, ui_scale(125));

        main_flex_right.set_pad(ui_scale(20));
        main_flex_right.set_margins(ui_scale(5),ui_scale(25),ui_scale(5),ui_scale(10));
        ...
        main_flex_wrapper.fixed(&status_frame_main, ui_scale(15)); //2
